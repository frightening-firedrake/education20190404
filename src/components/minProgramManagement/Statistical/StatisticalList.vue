...
export default {
  ...
  created() {
    ...
    this.$root.eventHub.$on(
      ...
      function(id, row) {
        ...
        //		}
        this.$router.push({
          path: "/index/minProgramManagement/StatisticalList/StatisticalView",
          query: { id: id }
        });
      }.bind(this)
    );
  ...
  data() {
    return {
      ...
      searchURL: this.apiRoot + "test/dataStatistical",
      deleteURL: this.apiRoot + "account/delete",
      carListUrl: this.apiRoot + "statistical/findSum",
      carList: {
        testSum: "",
        testerSum: "",
        testPass: "",
