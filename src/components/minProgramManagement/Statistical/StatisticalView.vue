    ...
    <div class='listpagewrap StatisticalList'>
	  	...
	  	<div class="StatisticalListRow">
		  	<div class="StatisticalListItemWrap" style="width:66%;">
    			...
    			<div class="chart" id="chartH" style="width:100%;">
...
//		    console.log(error);
//		}.bind(this));
		var data=[{"sum":2,"invalidNumber":0,"validNumber":1,"endNumber":0,"createTime":"2018-11-24"},{"sum":1,"invalidNumber":0,"validNumber":1,"endNumber":0,"createTime":"2018-11-25"},{"sum":1,"invalidNumber":0,"validNumber":1,"endNumber":0,"createTime":"2018-11-26"},{"sum":2,"invalidNumber":0,"validNumber":1,"endNumber":0,"createTime":"2018-11-27"},{"sum":3,"invalidNumber":0,"validNumber":3,"endNumber":0,"createTime":"2018-11-29"},{"sum":3,"invalidNumber":0,"validNumber":2,"endNumber":0,"createTime":"2018-11-30"},{"sum":4,"invalidNumber":0,"validNumber":3,"endNumber":0,"createTime":"2018-12-01"},{"sum":1,"invalidNumber":0,"validNumber":1,"endNumber":0,"createTime":"2018-12-02"},{"sum":2,"invalidNumber":0,"validNumber":2,"endNumber":0,"createTime":"2018-12-03"},{"sum":2,"invalidNumber":0,"validNumber":2,"endNumber":0,"createTime":"2018-12-04"},{"sum":4,"invalidNumber":0,"validNumber":1,"endNumber":0,"createTime":"2018-12-08"},{"sum":3,"invalidNumber":0,"validNumber":0,"endNumber":0,"createTime":"2018-12-10"}]
		var arr_sum=[];
    	var arr_validNumber=[];
    	data.forEach((value)=>{
    		var obj_sum=[];
...
//		        alwaysShowContent:true,
		        ...
		        formatter: function (params) {
		        	var str2="<div><p><span style='color:#333;'>"+params[0].data[0]+"</span></p><p>&nbsp;&nbsp;&nbsp;测试总人次：<span style='color:"+params[0].color+";'>"+params[0].data[1]+"次</span></p><p>测试合格人次：<span style='color:"+params[1].color+";'>"+params[1].data[1]+"次</span></p><p>合格率：<span style='color:#2abb03;'>"+Math.round(params[1].data[1]/params[0].data[1]*100)+"%</span></p><p style='text-align:center;'><span style='color:#333;'>"+params[0].name+"</span></p></div>";
		            return str2;
		        },
		        padding:[5,10,5,10],
		    },
		            ...
		            dataView: {
		            	...
		            	optionToContent: function(opt) {
						    ...
						    for (var i = 0, l = axisData.length; i < l; i++) {
						        table += '<tr>'
						                 + '<td>' + axisData[i][0] + '</td>'
						                 + '<td>' + series[0].data[i][1] + '次</td>'
						                 + '<td>' + series[1].data[i][1] + '次</td>'
